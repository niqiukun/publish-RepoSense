...
java -jar RepoSense.jar --config ./configs --repos https://github.com/reposense/RepoSense.git https://github.com/se-edu/collate.git --since 21/10/2017 --until 21/11/2019 --formats java adoc js --view
